...
\end{displayquote}
directory. Unless otherwise noted, \textit{we will retrict our attention to this directory when talking about working with TSPLIB data}. 
...
Here we compute the convex-hull of the point-set, delete the points from the hull. 
Compute the convex hull of the smalle point-set and keep repeating this process
...
This function basically given a set of node ids of a graph provided as a list of 
integers, returns a cycle consisting of edges with successive nodes joined in
the order provided. e.g. $[1,2,3] \rarr [(1,2),(2,3),(3,1)]$. 

\nwenddocs{}\nwbegincode{43}\sublabel{NWaGG5Z-2QHw3A-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-2QHw3A-1}}}\moddef{ Definition of \verb|circular_edge_zip|~{\nwtagstyle{}\subpageref{NWaGG5Z-2QHw3A-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-2XNY09-4}}\nwenddeflinemarkup
