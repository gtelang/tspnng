...
\end{displayquote}
directory. For all practical purposes, unless otherwise noted, \textit{we will retrict our attention to this directory when talking about working with TSPLIB data}. 
