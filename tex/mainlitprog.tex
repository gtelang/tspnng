...
\nwalsodefined{\\{NWaGG5Z-4cZhfD-2}\\{NWaGG5Z-4cZhfD-3}\\{NWaGG5Z-4cZhfD-4}\\{NWaGG5Z-4cZhfD-5}}\nwused{\\{NWaGG5Z-HXUTc-1}}\nwendcode{}\nwbegindocs{12}\nwdocspar
...
Given a stream of repeated data recordings for each fixed set of parameters
in experiments, this function will be used repeatedly. 

For those who know Haskell, this function accepts input of the type \texttt{{\Tt{}Double\nwendquote}}
and ``reduces'' each element in the outer array (each element is of type \texttt{[Double]})
...
below the mean of the stream of numbers. 

Thus the function basically replaces each stream in the array of streams, with an
error-interval


\nwenddocs{}\nwbegincode{85}\sublabel{NWaGG5Z-4cZhfD-5}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-5}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-4}{\relax}\nwenddeflinemarkup
