...
def get_knng_graph(points,k):
     ...
     return knng_graph
\nwalsodefined{\\{NWaGG5Z-2XNY09-2}\\{NWaGG5Z-2XNY09-3}\\{NWaGG5Z-2XNY09-4}\\{NWaGG5Z-2XNY09-5}}\nwused{\\{NWaGG5Z-HXUTc-1}}\nwendcode{}\nwbegindocs{30}\nwdocspar
...
for a documentation of the code in NetworkX used to compute the MST. Note that along with the Kruskal method (used below), both Prim's and Boruvka's 
