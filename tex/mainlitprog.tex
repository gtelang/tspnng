...
def multimodal_points(numpts, nummodes=4, sigma=0.05):
     ...
     return points
\nwalsodefined{\\{NWaGG5Z-4cZhfD-2}\\{NWaGG5Z-4cZhfD-3}\\{NWaGG5Z-4cZhfD-4}\\{NWaGG5Z-4cZhfD-5}\\{NWaGG5Z-4cZhfD-6}\\{NWaGG5Z-4cZhfD-7}\\{NWaGG5Z-4cZhfD-8}\\{NWaGG5Z-4cZhfD-9}\\{NWaGG5Z-4cZhfD-A}\\{NWaGG5Z-4cZhfD-B}\\{NWaGG5Z-4cZhfD-C}\\{NWaGG5Z-4cZhfD-D}\\{NWaGG5Z-4cZhfD-E}\\{NWaGG5Z-4cZhfD-F}}\nwused{\\{NWaGG5Z-HXUTc-1}}\nwendcode{}\nwbegindocs{12}\nwdocspar
...
\nwenddocs{}\nwbegincode{17}\sublabel{NWaGG5Z-4cZhfD-4}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-4}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-3}{NWaGG5Z-4cZhfD-5}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{19}\sublabel{NWaGG5Z-4cZhfD-5}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-5}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-4}{NWaGG5Z-4cZhfD-6}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{21}\sublabel{NWaGG5Z-4cZhfD-6}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-6}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-5}{NWaGG5Z-4cZhfD-7}\nwenddeflinemarkup
class TSPNNGInput:
...
\nwenddocs{}\nwbegincode{89}\sublabel{NWaGG5Z-4cZhfD-7}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-7}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-6}{NWaGG5Z-4cZhfD-8}\nwenddeflinemarkup
def hamilton(G):
    F = [(G,[list(G.nodes())[0]])]
    n = G.number_of_nodes()
    while F:
...
\nwenddocs{}\nwbegincode{91}\sublabel{NWaGG5Z-4cZhfD-8}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-8}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-7}{NWaGG5Z-4cZhfD-9}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{93}\sublabel{NWaGG5Z-4cZhfD-9}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-9}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-8}{NWaGG5Z-4cZhfD-A}\nwenddeflinemarkup
...
this function accepts input of the type [\![\texttt{Double}]\!] and ``reduces'' each 
...
\nwenddocs{}\nwbegincode{95}\sublabel{NWaGG5Z-4cZhfD-A}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-A}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-9}{NWaGG5Z-4cZhfD-B}\nwenddeflinemarkup
...
In the following routine we compute the maximally dispersed vertex cover for the supplied graph of the delaunay triangulation
...
The motivation for looking at Estie's paper was computing maximally dispersed guards in the annulus to answer Abhishek's
...
\nwenddocs{}\nwbegincode{97}\sublabel{NWaGG5Z-4cZhfD-B}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-B}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-A}{NWaGG5Z-4cZhfD-C}\nwenddeflinemarkup
def exists_disp_vertex_cover_more_than_bin_guess(graph,points,d):
     ...
     \LA{}Set up variables $x_i$ for each node of the graph~{\nwtagstyle{}\subpageref{NWaGG5Z-1YI2LW-1}}\RA{}
     \LA{}Set up clauses for each edge~{\nwtagstyle{}\subpageref{NWaGG5Z-2iZU13-1}}\RA{}
     \LA{}Create a clause for each pair of nodes whose distance is smaller than $d$~{\nwtagstyle{}\subpageref{NWaGG5Z-3YpnkD-1}}\RA{}
     \LA{}Solve the system with Minisat~{\nwtagstyle{}\subpageref{NWaGG5Z-4A3M70-1}}\RA{}
\nwused{\\{NWaGG5Z-HXUTc-1}}\nwendcode{}\nwbegindocs{98}\nwdocspar


\nwenddocs{}\nwbegincode{99}\sublabel{NWaGG5Z-1YI2LW-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-1YI2LW-1}}}\moddef{Set up variables $x_i$ for each node of the graph~{\nwtagstyle{}\subpageref{NWaGG5Z-1YI2LW-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-4cZhfD-B}}\nwenddeflinemarkup
xs = []
for idx in range(numpts):
    xs.append(Variable( 'x_'+str(idx) ))
print("     Created Variables....")
\nwused{\\{NWaGG5Z-4cZhfD-B}}\nwendcode{}\nwbegindocs{100}\nwdocspar


\nwenddocs{}\nwbegincode{101}\sublabel{NWaGG5Z-2iZU13-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-2iZU13-1}}}\moddef{Set up clauses for each edge~{\nwtagstyle{}\subpageref{NWaGG5Z-2iZU13-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-4cZhfD-B}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{103}\sublabel{NWaGG5Z-3YpnkD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-3YpnkD-1}}}\moddef{Create a clause for each pair of nodes whose distance is smaller than $d$~{\nwtagstyle{}\subpageref{NWaGG5Z-3YpnkD-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-4cZhfD-B}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{105}\sublabel{NWaGG5Z-4A3M70-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4A3M70-1}}}\moddef{Solve the system with Minisat~{\nwtagstyle{}\subpageref{NWaGG5Z-4A3M70-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-4cZhfD-B}}\nwenddeflinemarkup
solver = Minisat()
...
\nwenddocs{}\nwbegincode{107}\sublabel{NWaGG5Z-4cZhfD-C}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-C}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-B}{NWaGG5Z-4cZhfD-D}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{109}\sublabel{NWaGG5Z-4cZhfD-D}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-D}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-C}{NWaGG5Z-4cZhfD-E}\nwenddeflinemarkup
def list_points_in_node_order(graph):
     return [graph.nodes[idx]['coods'] for idx in range(len(graph.nodes))]
\nwused{\\{NWaGG5Z-HXUTc-1}}\nwendcode{}\nwbegindocs{110}\nwdocspar


\nwenddocs{}\nwbegincode{111}\sublabel{NWaGG5Z-4cZhfD-E}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-E}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-D}{NWaGG5Z-4cZhfD-F}\nwenddeflinemarkup
class Forest:
...
\nwenddocs{}\nwbegincode{113}\sublabel{NWaGG5Z-4cZhfD-F}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-F}}}\moddef{Generic utility classes and functions~{\nwtagstyle{}\subpageref{NWaGG5Z-4cZhfD-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-4cZhfD-E}{\relax}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{117}\sublabel{NWaGG5Z-3zYcKb-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWaGG5Z-3zYcKb-2}}}\moddef{Experiments~{\nwtagstyle{}\subpageref{NWaGG5Z-3zYcKb-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWaGG5Z-HXUTc-1}}\nwprevnextdefs{NWaGG5Z-3zYcKb-1}{\relax}\nwenddeflinemarkup
...
\nwixlogsorted{c}{{Create a clause for each pair of nodes whose distance is smaller than $d$}{NWaGG5Z-3YpnkD-1}{\nwixu{NWaGG5Z-4cZhfD-B}\nwixd{NWaGG5Z-3YpnkD-1}}}%
...
\nwixlogsorted{c}{{Generic utility classes and functions}{NWaGG5Z-4cZhfD-1}{\nwixu{NWaGG5Z-HXUTc-1}\nwixd{NWaGG5Z-4cZhfD-1}\nwixd{NWaGG5Z-4cZhfD-2}\nwixd{NWaGG5Z-4cZhfD-3}\nwixd{NWaGG5Z-4cZhfD-4}\nwixd{NWaGG5Z-4cZhfD-5}\nwixd{NWaGG5Z-4cZhfD-6}\nwixd{NWaGG5Z-4cZhfD-7}\nwixd{NWaGG5Z-4cZhfD-8}\nwixd{NWaGG5Z-4cZhfD-9}\nwixd{NWaGG5Z-4cZhfD-A}\nwixd{NWaGG5Z-4cZhfD-B}\nwixd{NWaGG5Z-4cZhfD-C}\nwixd{NWaGG5Z-4cZhfD-D}\nwixd{NWaGG5Z-4cZhfD-E}\nwixd{NWaGG5Z-4cZhfD-F}}}%
...
\nwixlogsorted{c}{{Set up clauses for each edge}{NWaGG5Z-2iZU13-1}{\nwixu{NWaGG5Z-4cZhfD-B}\nwixd{NWaGG5Z-2iZU13-1}}}%
\nwixlogsorted{c}{{Set up edge colors depending on graph type}{NWaGG5Z-3Ujbzt-1}{\nwixu{NWaGG5Z-3DI44N-5}\nwixd{NWaGG5Z-3Ujbzt-1}}}%
\nwixlogsorted{c}{{Set up variables $x_i$ for each node of the graph}{NWaGG5Z-1YI2LW-1}{\nwixu{NWaGG5Z-4cZhfD-B}\nwixd{NWaGG5Z-1YI2LW-1}}}%
\nwixlogsorted{c}{{Solve the system with Minisat}{NWaGG5Z-4A3M70-1}{\nwixu{NWaGG5Z-4cZhfD-B}\nwixd{NWaGG5Z-4A3M70-1}}}%
