...
\begin{figure}[ht]
  ...
  \includegraphics[width=5cm]{./miscimages/2nng-example.png}
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:dt} Example of a Minimum Spanning Tree computed by NetworkX on 30 randomly generated points}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{\label{fig:dt} Example of the Onion graph computed with computed with QHull (through SciPy) on 30 randomly generated points }
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:dt} Example of an \underline{optimal} TSP tour computed with Concorde  on 30 randomly generated points }
\end{figure}
